/**
 * PharmaLens Archival Controller
 * ================================
...
const exportReportPDF = async (req, res) => {
  try {
    ...
    res.setHeader(
      'Content-Disposition',
      `attachment; filename=PharmaLens_${report.molecule}_${report.requestId}.pdf`
    );
    ...
    // Add content
    doc.fontSize(24).text('PharmaLens Research Report', { align: 'center' });
    doc.moveDown();
    ...
    // Footer
    doc.fontSize(10)
      .text('Generated by PharmaLens AI - Drug Repurposing Intelligence Platform', 
