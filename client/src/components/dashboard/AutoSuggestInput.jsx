/**
 * PharmaLens Auto-Suggest Input Component
 * =========================================
...
const AutoSuggestInput = ({ 
  ...
  useEffect(() => {
    const stored = localStorage.getItem('pharmalens_recent_searches');
    if (stored) {
  ...
  const selectSuggestion = (suggestion) => {
    ...
    localStorage.setItem('pharmalens_recent_searches', JSON.stringify(updated));
