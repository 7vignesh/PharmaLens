/**
 * PharmaLens PDF Report Generator Component
 * ==========================================
...
<head>
  <meta charset="UTF-8">
  <title>PharmaLens Investment Brief - ${molecule}</title>
  <style>
...
<body>
  <div class="header">
    ...
    <div class="meta">
      ...
      <span>Mode: ${mode === 'secure' ? 'Secure (Local)' : 'Cloud (GPT-4)'}</span>
...
`;
    ...
    content += `
  <div class="footer">
    <p>Generated by PharmaLens AI Platform | © 2024 PharmaLens. All rights reserved.</p>
...
`;
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `PharmaLens_Report_${molecule}_${new Date().toISOString().split('T')[0]}.html`;
